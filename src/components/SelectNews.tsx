...
export default function Select({
    ...
    return (
        <div
            ref={containerRef}
            className={`relative inline-block text-left text-isd-secondary text-lg ${className}`}
        >
            <button
                id={id}
                ref={buttonRef}
                ...
                className="w-full flex items-center justify-between px-[12px] h-component-gap-sm  focus:outline-none border-b-1"
            >
                    ...
                    >
                        {options.map((opt, idx) => {
                            ...
                            return (
                                ...
                                >
                                    <span className="truncate text-isd-font-3 text-sm">
                                        {opt.label}
                                    </span>
                                </li>
                            );
