...
export default function ProgramBlock() {
    ...
    return (
        <div>
            <div className="container relative flex flex-col py-section-gap gap-section-title-gap dot-pattern before:top-[-95px] before:right-[-90px] [--dot-color:var(--isd-secondary-1)]">
